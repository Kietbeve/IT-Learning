    ...
    <div class="container mx-auto px-4 max-w-7xl">
            ...
            <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-800"><?php echo e($totalAssigned); ?></p>
                    </div>
            ...
            <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-800"><?php echo e($totalPending); ?></p>
                    </div>
            ...
            <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-800"><?php echo e($reviewerStats['total_reviews'] ?? 0); ?></p>
                    </div>
            ...
            <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-800"><?php echo e($reviewerStats['approval_rate'] ?? 0); ?>%</p>
                    </div>
        ...
        <div class="mb-8 rounded-3xl bg-white p-6 shadow-sm border border-slate-100">
            <div class="flex flex-wrap items-center gap-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $filterStatus !== 'all' || $filterPending): ?>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $projectsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                ...
                <div 
                    class="group relative overflow-hidden rounded-3xl bg-white shadow-sm border border-slate-100 transition-all duration-300 flex flex-col <?php echo e($canAccess ? 'cursor-pointer hover:shadow-lg hover:-translate-y-1 hover:border-blue-200' : 'cursor-not-allowed opacity-60'); ?>"
                    <?php if($canAccess): ?>
                        wire:click="viewProjectSubmissions(<?php echo e($project->id); ?>)"
                    <?php endif; ?>
                >
                    ...
                    <div class="p-6 flex flex-col flex-1 mt-6">
                        <h3 class="mb-2 text-xl font-extrabold text-slate-800 line-clamp-2 <?php echo e($canAccess ? 'group-hover:text-blue-600 transition-colors' : ''); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->roadmap): ?>
                            <div class="mb-5 flex items-center gap-2 text-xs font-semibold text-slate-600 bg-slate-50 w-max px-3 py-1.5 rounded-xl border border-slate-100">
                                ...
                                <span><?php echo e($project->roadmap->title); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="flex items-center justify-between border-t border-slate-100 pt-4 mt-auto">
                                <div class="flex items-center gap-4 text-sm font-bold">
                                    <div class="flex items-center gap-1.5 text-amber-500 bg-amber-50 px-2.5 py-1 rounded-lg border border-amber-100" title="Đang chờ chấm">
                                        ...
                                        <span><?php echo e($pendingCount); ?> chờ</span>
                                    </div>
                                    <div class="flex items-center gap-1.5 text-slate-600 bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-200">
                                        ...
                                        <span><?php echo e($project->submissions->count()); ?> học viên</span>
                                    </div>
                                </div>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reviewerInfo && $reviewerInfo->can_final_grade): ?>
        ...
        <div class="mt-8">
            <?php echo e($projectsData->links()); ?>

        </div>
    </div>
</div>
<?php /**PATH D:\IT-Learning\Modules/Learning\resources/views/livewire/reviewer/reviewer-submissions-list.blade.php ENDPATH**/ ?>