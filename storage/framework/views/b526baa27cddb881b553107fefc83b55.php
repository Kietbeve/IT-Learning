...
<head>
    ...
    <title><?php echo e($title ?? 'Học tập'); ?> - ITLearning</title>
        ...
        <div class="px-4 md:px-8 py-2.5 flex justify-between items-center">
            <div class="flex items-center gap-3 flex-1 min-w-0">
                ...
                <a href="/" class="flex items-center gap-1 text-white text-lg font-bold hover:opacity-80 transition-opacity shrink-0">
                    <img src="<?php echo e(asset('Image/logo.png')); ?>" alt="Logo" class="h-8 w-auto object-contain">
                ...
                <nav class="flex items-center gap-2 text-sm flex-1 min-w-0">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('learning.roadmaps.index')); ?>" class="text-slate-300 hover:text-white transition-colors">
                            Lộ trình học tập
                        </a>
            ...
            <div class="flex items-center gap-3 shrink-0" x-data="{ open: false }">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <div class="relative">
                        <button @click="open = !open" @click.outside="open = false" class="flex items-center gap-2 text-white hover:text-blue-400 transition-colors focus:outline-none">
                            ...
                            <span class="font-medium hidden sm:block text-sm"><?php echo e(Auth::user()->name); ?></span>
                        ...
                        <div x-show="open" 
                            ...
                            <a href="<?php echo e(route('auth.profile')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                Hồ sơ cá nhân
                            </a>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('auth.google.redirect')); ?>" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors">
                        Đăng nhập
                    </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
...
<?php /**PATH D:\IT-Learning\Modules/Learning\resources/views/layouts/learning-layout.blade.php ENDPATH**/ ?>