<div class="space-y-8 font-sans pb-10">
                ...
                <div class="flex items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-xl font-black text-white tracking-tight">
                            <?php echo e(number_format($balance, 0, ',', '.')); ?>đ
                        </p>
                    </div>
                    <a href="<?php echo e(route('contributor.payout-request')); ?>" class="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-white/10 hover:bg-white/20 text-white transition-colors" title="Rút tiền">
    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between px-1">
            ...
            <a href="<?php echo e(route('contributor.payout-request')); ?>" class="text-xs font-bold text-indigo-600 hover:text-indigo-550 transition-colors uppercase tracking-wider">Ví & Giao dịch →</a>
        </div>
        <div class="grid gap-6 grid-cols-2 lg:grid-cols-3">
            ...
            <article class="relative overflow-hidden rounded-3xl border border-white bg-white/70 p-6 shadow-xl shadow-slate-100/50 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
                ...
                <p class="mt-4 text-3xl font-black text-slate-800 tracking-tight"><?php echo e(number_format($todayEarnings)); ?>đ</p>
            ...
            <article class="relative overflow-hidden rounded-3xl border border-white bg-white/70 p-6 shadow-xl shadow-slate-100/50 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
                ...
                <p class="mt-4 text-3xl font-black text-slate-800 tracking-tight"><?php echo e(number_format($earningsThisMonth)); ?>đ</p>
                <p class="text-xs <?php echo e($changePercent >= 0 ? 'text-green-700 bg-green-50/50 border-green-100' : 'text-red-700 bg-red-50/50 border-red-100'); ?> font-bold border px-2 py-0.5 rounded-lg inline-block mt-1.5">
                    <?php echo e($changePercent >= 0 ? '↑' : '↓'); ?> <?php echo e(abs($changePercent)); ?>% vs tháng trước
                </p>
            </article>
            ...
            <article class="relative overflow-hidden rounded-3xl border border-white bg-white/70 p-6 shadow-xl shadow-slate-100/50 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
                ...
                <p class="mt-4 text-3xl font-black text-slate-800 tracking-tight"><?php echo e(number_format($earningsLastMonth)); ?>đ</p>
    ...
    <section class="overflow-hidden rounded-[2rem] border border-white bg-white/70 shadow-xl shadow-slate-100/50 backdrop-blur-md">
        <div class="p-6 border-b border-indigo-50/50 bg-indigo-50/10 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('contributor.documents.index')); ?>" class="text-xs font-bold text-indigo-600 hover:text-indigo-550 transition-colors uppercase tracking-wider">Tất cả tài liệu →</a>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-indigo-50/40 text-sm text-slate-650">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $latestDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-indigo-50/10 transition-colors duration-200">
                            <td class="px-6 py-4">
                                <span class="block max-w-xs truncate font-bold text-slate-800" title="<?php echo e($doc->title); ?>"><?php echo e($doc->title); ?></span>
                                <div class="flex items-center gap-2 mt-1 flex-wrap">
                                    <span class="inline-block text-[9px] font-bold text-indigo-600 bg-indigo-50/80 border border-indigo-100/50 px-1.5 py-0.5 rounded uppercase"><?php echo e($doc->file_type); ?> • <?php echo e(number_format($doc->file_size / 1024 / 1024, 2)); ?> MB</span>
                                    <span class="inline-flex items-center gap-1.5 text-[10px] text-slate-400 font-bold">
                                        <span>Tải: <?php echo e(number_format($doc->download_count)); ?></span>
                                        <span>•</span>
                                        <span>Xem: <?php echo e(number_format($doc->view_count)); ?></span>
                                        <span>•</span>
                                        <span class="flex items-center text-rose-600">
                                            ...
                                            <?php echo e(number_format($doc->favorite_count)); ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap items-center gap-1.5">
                                    <span class="inline-flex items-center gap-1 rounded bg-blue-50 px-1.5 py-0.5 text-[10px] font-bold text-blue-700">
                                        ...
                                        <?php echo e($doc->category?->name ?? 'Chưa phân loại'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($doc->status === 'approved'): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <tr>
                            <td colspan="5" class="px-6 py-8 text-center text-slate-400 bg-indigo-50/5">
                                Bạn chưa đăng tải tài liệu nào. <a href="<?php echo e(route('contributor.documents.create')); ?>" class="text-indigo-600 hover:underline font-semibold">Tải lên ngay</a>.
                            </td>
                        </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </tbody>
...
<?php /**PATH D:\IT-Learning\Modules/Document\resources/views/livewire/contributor/dashboard.blade.php ENDPATH**/ ?>