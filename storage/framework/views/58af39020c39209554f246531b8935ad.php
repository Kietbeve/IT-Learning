<?php $__env->startSection('breadcrumb'); ?>
    <a href="<?php echo e(route('learning.roadmaps.index')); ?>" class="text-slate-300 hover:text-white transition-colors flex items-center gap-1">
        Lộ trình học tập
    </a>
    <svg class="w-4 h-4 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
    </svg>
    <a href="<?php echo e(route('learning.roadmaps.show', $roadmap->id)); ?>" class="text-slate-300 hover:text-white transition-colors truncate max-w-[200px] md:max-w-xs">
...
<div class="flex flex-col h-[calc(100vh-52px)] bg-gray-50 text-gray-900 font-sans antialiased overflow-hidden" x-data="lessonController()">
        ...
        <aside x-show="sidebarOpen"
            ...
            <div class="p-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between sticky top-0 z-10">
                ...
                <span class="text-xs bg-cyan-100 text-cyan-800 font-bold px-2 py-0.5 rounded-full">
                    <?php echo e($roadmap->lessons->count()); ?> Bài học
                </span>
            </div>
            
            <div class="divide-y divide-gray-200">
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $roadmap->sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="bg-gray-50/70">
                        ...
                        <div class="divide-y divide-gray-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $section->lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <a href="<?php echo e(route('learning.roadmaps.learn', [$roadmap->id, $lesson->id])); ?>" 
                                   class="flex items-center justify-between px-4 py-3 text-sm transition-all <?php echo e($currentLesson->id == $lesson->id ? 'bg-cyan-50 text-cyan-700 font-bold border-l-4 border-cyan-600' : 'text-gray-600 hover:bg-gray-50'); ?>">
                                    <div class="flex items-center gap-2 truncate">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($lesson->lesson_type ?? 'text') == 'video'): ?>
                                            <span class="text-xs">▶️</span>
                                        <?php else: ?>
                                            <span class="text-xs">📄</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <span class="truncate"><?php echo e($lesson->title); ?></span>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($lesson->id, is_array($progressList) ? $progressList : $progressList->toArray())): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($roadmap->lessons->whereNull('section_id')->count() > 0): ?>
                    <div>
                        <div class="px-4 py-2.5 font-bold text-xs text-gray-500 uppercase tracking-wider bg-gray-100/60 border-b border-gray-200/50">
                            Bài học bổ sung
                        </div>
                        <div class="divide-y divide-gray-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $roadmap->lessons->whereNull('section_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <a href="<?php echo e(route('learning.roadmaps.learn', [$roadmap->id, $lesson->id])); ?>" 
                                   class="flex items-center justify-between px-4 py-3 text-sm transition-all <?php echo e($currentLesson->id == $lesson->id ? 'bg-cyan-50 text-cyan-700 font-bold border-l-4 border-cyan-600' : 'text-gray-600 hover:bg-gray-50'); ?>">
                                    <div class="flex items-center gap-2 truncate">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($lesson->lesson_type ?? 'text') == 'video'): ?>
            ...
            <div class="max-w-5xl mx-auto w-full">
                <div class="bg-white border border-gray-200 rounded-2xl p-5 md:p-7 mb-6 shadow-sm">
                    <span class="text-[10px] font-black uppercase tracking-widest text-cyan-800 bg-cyan-100 px-2.5 py-1 rounded-md border border-cyan-200 mb-3 inline-block">
                        Bài học dạng: <?php echo e(strtoupper($currentLesson->lesson_type ?? 'Text')); ?>

                    </span>
                    <h1 class="text-xl md:text-2xl font-black text-gray-900 tracking-tight mb-4">
                        <?php echo e($currentLesson->title); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($currentLesson->content)): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($currentLesson->video_url)): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentLesson->exam_id && $currentLesson->exam): ?>
                        ...
                        <div class="bg-gradient-to-r from-blue-700 to-blue-500 p-6 text-white">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <h3 class="text-2xl font-bold"><?php echo e($currentLesson->exam->title); ?></h3>
                                    <p class="text-blue-100 text-sm mt-2"><?php echo e($currentLesson->exam->description); ?></p>
                                </div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                <div class="rounded-2xl bg-slate-50 p-4">
                                    ...
                                    <div class="font-bold text-slate-900 text-lg"><?php echo e($currentLesson->exam->duration_minutes); ?> phút</div>
                                </div>

                                <div class="rounded-2xl bg-slate-50 p-4">
                                    <div class="text-slate-500 text-xs mb-1">Số câu hỏi</div>
                                    <div class="font-bold text-slate-900 text-lg"><?php echo e($currentLesson->exam->questions->count()); ?></div>
                                </div>

                                <div class="rounded-2xl bg-slate-50 p-4">
                                    <div class="text-slate-500 text-xs mb-1">Điểm đạt</div>
                                    <div class="font-bold text-slate-900 text-lg"><?php echo e(rtrim(rtrim($currentLesson->exam->pass_percent, '0'), '.')); ?>%</div>
                                </div>

                                <div class="rounded-2xl bg-slate-50 p-4">
                                    <div class="text-slate-500 text-xs mb-1">Hình thức</div>
                                    <div class="font-bold text-slate-900 text-lg"><?php echo e(ucfirst($currentLesson->exam->type)); ?></div>
                                </div>
                            </div>
                            ...
                            <form method="POST"
                                x-ref="examForm" 
                                  action="<?php echo e(route('exam.attempt.start', $currentLesson->exam->slug)); ?>"
                                        ...
                                        <div @click.stop
                                            ...
                                            <div class="p-8">
                                                ...
                                                <p class="text-slate-600 mb-4">
                                                    Bạn có chắc chắn muốn bắt đầu bài kiểm tra này? Bài kiểm tra có thời gian giới hạn <?php echo e($currentLesson->exam->duration_minutes); ?> phút.
                                                </p>

                                                <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 text-sm text-blue-800">
                                                    💡 <strong>Lưu ý:</strong> Hoàn thành tối thiểu <?php echo e(rtrim(rtrim($currentLesson->exam->pass_percent, '0'), '.')); ?>% số điểm để vượt qua bài thi.
                                                </div>
                                            </div>
    ...
    <button
                            ...
                            <div class="mt-4 bg-blue-50 border border-blue-200 rounded-xl p-4 flex gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-blue-700 mt-1">
                                        • Bài kiểm tra có thời gian giới hạn <?php echo e($currentLesson->exam->duration_minutes); ?> phút<br>
                                        • Cần đạt tối thiểu <?php echo e(rtrim(rtrim($currentLesson->exam->pass_percent, '0'), '.')); ?>% để hoàn thành<br>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentLesson->document_id && $currentLesson->document): ?>
                <?php
                ...
                ?>
                    ...
                    <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-lg mb-6">
                            ...
                            <div class="flex items-start justify-between gap-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-12 h-12 bg-orange-600 rounded-xl flex items-center justify-center text-2xl">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fileType === 'zip'): ?> 📦 <?php else: ?> 📄 <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <div>
                                        <h3 class="font-bold text-gray-900 text-lg"><?php echo e($doc->title); ?></h3>
                                        <p class="text-xs text-gray-600 mt-1">
                                            <?php echo e(strtoupper($fileType)); ?> • <?php echo e(number_format($doc->file_size / 1024 / 1024, 2)); ?> MB
                                        </p>
                                    </div>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($doc->is_downloadable && !empty($fileUrl)): ?>
                        ...
                        <div class="p-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fileType === 'zip' && count($zipFiles) > 0): ?>
                                <div x-data="{ 
                                    isFullscreen: false,
                                    selectedFile: null, 
                                    showTree: true,
                                    selectFile(path) {
                                        ...
                                        this.$nextTick(() => {
                                            let container = document.getElementById('lesson-code-preview-<?php echo e($documentId); ?>');
                                            if (container) {
                                    ...
                                    <div class="rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50 p-5 flex items-center justify-between gap-4 hover:shadow-md transition-shadow">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600 mt-0.5"><?php echo e(count($zipFiles)); ?> files trong ZIP</p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="rounded-xl border border-gray-200 bg-gray-50 overflow-hidden flex h-full">
                                                <div x-show="showTree" class="w-64 border-r border-gray-200 bg-white overflow-y-auto shrink-0">
                                                    <div class="p-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                                                        ...
                                                        <p class="text-xs text-gray-500 mt-1"><?php echo e(count($zipFiles)); ?> files</p>
                                                    </div>
                                                    <div class="p-3">
                                                        <?php
                                                            $tree = [];
                                                ...
                                                <div class="flex-1 bg-white overflow-hidden flex flex-col" id="lesson-code-preview-<?php echo e($documentId); ?>">
                                                    ...
                                                    <div class="flex-1 overflow-y-auto overflow-x-auto">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $zipFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $path => $fileData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                            <?php
                                                            ...
                                                            ?>
                                                            <div x-show="selectedFile === '<?php echo e($path); ?>'" data-path="<?php echo e($path); ?>" style="display: none;">
                                                                <pre class="!m-0 !rounded-none" style="font-size: 13px; line-height: 1.6; padding: 1.5rem; background: #fafafa;"><code class="language-<?php echo e($lang); ?>" style="font-size: 13px; line-height: 1.6;"><?php echo e($fileData['content']); ?></code></pre>
                                                            </div>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                    </div>
                                                </div>
                            ...
                            <?php elseif($fileType === 'pdf' && !empty($fileUrl)): ?>
                                <div class="space-y-4">
                                    ...
                                    <div class="rounded-xl overflow-hidden border border-gray-300 shadow-inner bg-gray-100" style="height: 750px;">
                                        <iframe src="<?php echo e($fileUrl); ?>#toolbar=0" 
                                                class="w-full h-full border-0"
                                                id="pdf-frame-<?php echo e($documentId); ?>">
                                        </iframe>
                                    </div>
                            ...
                            <?php else: ?>
                                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-8 text-center">
                                    ...
                                    <p class="text-yellow-700 text-sm mb-4">
                                        File <?php echo e(strtoupper($fileType)); ?> không thể hiển thị trên trình duyệt.<br>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentLesson->project_id && isset($currentLesson->project)): ?>
                    <div class="mb-6">
...
[$__name, $__params] = $__split('modules.learning.http.livewire.student.submit-project', ['projectId' => $currentLesson->project_id]);

$__keyOuter = $__key ?? null;

$__key = 'project-submit-'.$currentLesson->project_id;
$__componentSlots = [];

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-975616323-0', $__key);
...
[$__name, $__params] = $__split(\Modules\Learning\Livewire\Forum\LessonDiscussion::class, [
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-975616323-1', $__key);
...
?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$currentLesson->project_id): ?>
                <div class="mt-8 bg-gradient-to-r from-cyan-50 to-blue-50 border border-cyan-200 rounded-2xl p-6 shadow-sm">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <form action="<?php echo e(route('learning.lessons.complete', [$roadmap->id, $currentLesson->id])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('learning::layouts.learning-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\IT-Learning\Modules/Learning\resources/views/layouts/lesson-view.blade.php ENDPATH**/ ?>