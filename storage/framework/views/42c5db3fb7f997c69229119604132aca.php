<div class="min-h-screen bg-slate-50 py-8 font-sans text-slate-900">
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="mb-6">
            <a href="<?php echo e(route(auth()->user()->hasRole('admin') ? 'admin.reviewer.submissions.index' : 'contributor.reviewer.submission.index')); ?>" 
        ...
        <div class="relative mb-8 overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-purple-600 to-fuchsia-600 p-8 shadow-xl text-white">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                <div class="flex-1">
                    ...
                    <p class="mt-3 text-indigo-50 max-w-2xl leading-relaxed text-base"><?php echo e($project->description); ?></p>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->roadmap): ?>
                        <div class="mt-6 inline-flex items-center gap-2 rounded-xl bg-black/20 px-4 py-2.5 text-sm font-medium backdrop-blur-sm border border-white/10 shadow-inner">
                            ...
                            <span>Lộ trình: <span class="text-white font-bold"><?php echo e($project->roadmap->title); ?></span></span>
                        </div>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-3 shrink-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('admin')): ?>
                        <a href="<?php echo e(route('admin.learning.projects.steps', $project->id)); ?>" 
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reviewerAssignment && $reviewerAssignment->can_final_grade): ?>
            ...
            <div class="group rounded-3xl bg-white p-6 shadow-sm border border-slate-100 hover:shadow-xl hover:border-blue-100 transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-3 text-4xl font-extrabold text-slate-900 group-hover:text-blue-600 transition-colors"><?php echo e($projectStats['total']); ?></p>
                    </div>
            ...
            <div class="group rounded-3xl bg-white p-6 shadow-sm border border-slate-100 hover:shadow-xl hover:border-amber-100 transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-3 text-4xl font-extrabold text-slate-900 group-hover:text-amber-500 transition-colors"><?php echo e($projectStats['pending']); ?></p>
                    </div>
            ...
            <div class="group rounded-3xl bg-white p-6 shadow-sm border border-slate-100 hover:shadow-xl hover:border-purple-100 transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-3 text-4xl font-extrabold text-slate-900 group-hover:text-purple-600 transition-colors"><?php echo e($projectStats['in_progress']); ?></p>
                    </div>
            ...
            <div class="group rounded-3xl bg-white p-6 shadow-sm border border-slate-100 hover:shadow-xl hover:border-emerald-100 transition-all duration-300 relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-3 text-4xl font-extrabold text-slate-900 group-hover:text-emerald-500 transition-colors"><?php echo e($projectStats['completed']); ?></p>
                    </div>
        ...
        <div class="mb-6 rounded-2xl bg-white p-5 shadow-sm border border-slate-200">
            <div class="flex flex-col md:flex-row md:items-center gap-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($searchStudent || $filterStatus !== 'all'): ?>
        ...
        <div class="mb-4 rounded-2xl bg-white p-5 shadow-sm border border-slate-200">
            <div class="grid grid-cols-12 gap-6 items-center text-xs font-bold text-slate-500 uppercase tracking-wider">
                ...
                <div class="col-span-6 grid grid-cols-<?php echo e(count($steps)); ?> gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="text-center group relative cursor-default">
                            <div class="mx-auto flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 text-slate-600 font-bold mb-1 transition-colors group-hover:bg-indigo-100 group-hover:text-indigo-600"><?php echo e($step->step_order); ?></div>
                            <div class="truncate text-[10px]"><?php echo e($step->step_name); ?></div>
        ...
        <div class="space-y-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $submissionsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                ...
                <div class="group relative rounded-2xl bg-white p-5 shadow-sm border border-slate-100 hover:shadow-lg hover:border-indigo-100 transition-all duration-300">
                    <div class="grid grid-cols-12 gap-6 items-center">
                        ...
                        <div class="col-span-3">
                            <div class="flex items-center gap-4">
                                <div class="relative h-12 w-12 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform duration-300">
                                    <span class="text-sm font-bold"><?php echo e(strtoupper(substr($student->name, 0, 2))); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingSteps > 0): ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 truncate max-w-[150px]"><?php echo e($student->email); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-span-2 pr-4">
                            <div class="flex flex-col gap-1.5">
                                <div class="flex justify-between items-center text-xs font-bold text-slate-700">
                                    ...
                                    <span><?php echo e(round($submission->progress_percent)); ?>%</span>
                                </div>
                                <div class="h-2 rounded-full bg-slate-100 overflow-hidden">
                                    <div class="h-full rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 transition-all duration-1000 ease-out" style="width: <?php echo e($submission->progress_percent); ?>%"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-span-6 grid grid-cols-<?php echo e(count($steps)); ?> gap-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stepProgress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stepItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                ...
                                <div class="flex justify-center">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stepSubmission): ?>
                                        <button 
                                            wire:click="reviewStepSubmission(<?php echo e($stepSubmission->id); ?>)"
                                            class="group/btn h-10 w-10 rounded-xl <?php echo e($bgColor); ?> flex items-center justify-center transition-all duration-300 hover:scale-110 hover:-translate-y-1 hover:shadow-md cursor-pointer relative"
                                            title="<?php echo e($stepItem['step']->step_name); ?> - Click để xem"
                                        >
                                            ...
                                            <?php else: ?>
                                                ...
                                                <svg class="h-5 w-5 <?php echo e($iconColor); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    ...
                                    <?php else: ?>
                                        <div class="h-10 w-10 rounded-xl <?php echo e($bgColor); ?> flex items-center justify-center opacity-50 border border-dashed border-slate-300">
                                            <svg class="h-4 w-4 <?php echo e($iconColor); ?>" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="mt-8">
            <?php echo e($submissionsData->links()); ?>

        </div>
    </div>
</div>
<?php /**PATH D:\IT-Learning\Modules/Learning\resources/views/livewire/reviewer/project-submissions-list.blade.php ENDPATH**/ ?>