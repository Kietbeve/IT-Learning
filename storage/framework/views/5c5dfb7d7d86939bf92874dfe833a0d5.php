    ...
    <div class="container mx-auto px-4 max-w-7xl">
            ...
            <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-800"><?php echo e($overallStats['total_projects']); ?></p>
                    </div>
            ...
            <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-800"><?php echo e($overallStats['with_reviewers']); ?></p>
                    </div>
            ...
            <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-800"><?php echo e($overallStats['without_reviewers']); ?></p>
                    </div>
            ...
            <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div>
                        ...
                        <p class="text-4xl font-black text-slate-800"><?php echo e($overallStats['total_assignments']); ?></p>
                    </div>
        ...
        <div class="mb-8 rounded-3xl bg-white p-6 shadow-sm border border-slate-100">
            <div class="flex flex-wrap items-center gap-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($searchProject || $filterHasReviewers !== 'all'): ?>
                ...
                <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 hover:shadow-lg transition-all duration-300 group flex flex-col">
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1 pr-4">
                            ...
                            <h3 class="text-xl font-extrabold text-slate-800 line-clamp-1 group-hover:text-indigo-600 transition-colors"><?php echo e($project->title); ?></h3>
                            <p class="mt-2 text-sm text-slate-500 line-clamp-2 leading-relaxed"><?php echo e($project->description); ?></p>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->roadmap): ?>
                                <div class="mt-4 flex items-center gap-2 text-xs font-semibold text-slate-600 bg-slate-50 w-max px-3 py-1.5 rounded-xl border border-slate-100">
                                    ...
                                    <span>Lộ trình: <?php echo e($project->roadmap->title); ?></span>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="mt-auto pt-4 border-t border-slate-100">
                        <div class="flex items-center justify-between mb-4">
                            <h4 class="text-xs font-bold uppercase tracking-wider text-slate-500">Người chấm được phân công (<?php echo e($project->reviewers->where('is_active', true)->count()); ?>)</h4>
                            <button 
                                wire:click="openAssignModal(<?php echo e($project->id); ?>)"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->reviewers->where('is_active', true)->count() > 0): ?>
                            <div class="flex flex-col gap-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $project->reviewers->where('is_active', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reviewer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="flex items-center justify-between rounded-2xl bg-slate-50 border border-slate-100 p-3 hover:border-indigo-200 transition-colors">
                                        <div class="flex items-center gap-3">
                                            <div class="h-10 w-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center shadow-inner text-white font-bold text-sm">
                                                <?php echo e(strtoupper(substr($reviewer->user->name, 0, 2))); ?>

                                            </div>
                                            <div>
                                                <p class="font-bold text-slate-800 text-sm"><?php echo e($reviewer->user->name); ?></p>
                                                <div class="flex items-center gap-2 mt-0.5">
                                                    <span class="text-[11px] font-medium text-slate-500 bg-white px-2 py-0.5 rounded-lg border border-slate-200"><?php echo e($reviewer->reviews_count); ?> reviews</span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reviewer->can_final_grade): ?>
                                        ...
                                        <div class="flex items-center gap-1.5">
                                            <button 
                                                wire:click="toggleFinalGrade(<?php echo e($reviewer->id); ?>)"
                                                class="rounded-xl p-2 <?php echo e($reviewer->can_final_grade ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 'bg-white text-slate-400 border border-slate-200'); ?> hover:shadow-sm transition-all"
                                                title="<?php echo e($reviewer->can_final_grade ? 'Thu hồi quyền chấm điểm cuối' : 'Cấp quyền chấm điểm cuối'); ?>"
                                            >
                                            ...
                                            <button 
                                                wire:click="removeReviewer(<?php echo e($project->id); ?>, <?php echo e($reviewer->user_id); ?>)"
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 w-full text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedProject): ?>
                                        <p class="mt-2 text-sm text-gray-600"><?php echo e($selectedProject->title); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="mt-6 space-y-5">
                                        <div>
                                            ...
                                            <select wire:model="selectedUserId" class="mt-1 block w-full rounded-xl border-slate-200 px-4 py-3 bg-slate-50 focus:border-indigo-500 focus:ring-indigo-500 transition-colors font-medium text-slate-700">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availableReviewers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="mt-2 block text-xs font-semibold text-rose-600"><?php echo e($message); ?></span> <?php unset($message);
...
<?php /**PATH D:\IT-Learning\Modules/Learning\resources/views/livewire/admin/manage-project-reviewers.blade.php ENDPATH**/ ?>