<header class="border-b border-slate-200 bg-white px-4 py-4 shadow-sm sm:px-6 lg:px-8 font-sans">
    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-sm font-medium uppercase tracking-[0.24em] text-slate-500"><?php echo e($isContributor ? 'Contributor' : 'Admin'); ?></p>
                <h2 class="text-xl font-semibold text-slate-900"><?php echo e($title ?? 'Control Panel'); ?></h2>
            </div>
        </div>

        <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
            <div class="flex items-center gap-3 rounded-3xl border border-slate-200 bg-slate-50 px-3 py-2">
                <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-slate-900 text-white font-bold"><?php echo e($isContributor ? 'C' : 'A'); ?></div>
                <div>
                    <p class="text-sm font-semibold text-slate-900"><?php echo e($activeUser?->name ?? ($isContributor ? 'Contributor' : 'Admin')); ?></p>
...
<?php /**PATH D:\IT-Learning\resources\views/layouts/patials/header.blade.php ENDPATH**/ ?>