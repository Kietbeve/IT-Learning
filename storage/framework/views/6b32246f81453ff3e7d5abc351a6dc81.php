<aside class="hidden w-72 shrink-0 border-r border-slate-200 bg-white px-4 py-6 lg:block overflow-y-auto h-screen sticky top-0 custom-scrollbar">
    ...
    <nav class="space-y-1">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            ?>
            <a href="<?php echo e(route($item['route'])); ?>" class="flex items-center gap-3 rounded-3xl px-4 py-3 text-sm font-medium transition-colors duration-200 <?php echo e($active ? 'bg-slate-900 text-white shadow-lg shadow-slate-900/5' : 'text-slate-700 hover:bg-slate-100 hover:text-slate-900'); ?>">
                <span class="inline-flex h-10 w-10 items-center justify-center rounded-2xl <?php echo e($active ? 'bg-white/10' : 'bg-slate-100'); ?>">
...
<?php /**PATH D:\IT-Learning\resources\views/layouts/patials/sidebar.blade.php ENDPATH**/ ?>