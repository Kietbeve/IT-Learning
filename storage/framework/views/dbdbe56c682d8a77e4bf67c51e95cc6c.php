...
<body>
    <div class="flex flex-col min-h-screen font-sans text-gray-800">
        <!-- User Header -->
        <?php echo $__env->make('layouts.patials.user_header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <!-- User Footer -->
        <?php echo $__env->make('layouts.patials.user_footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
...
<?php /**PATH D:\IT-Learning\resources\views/layouts/user.blade.php ENDPATH**/ ?>