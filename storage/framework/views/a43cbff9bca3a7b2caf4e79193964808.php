<div class="min-h-screen bg-slate-50 pb-12 font-sans text-slate-900">
    ...
    <div class="relative mb-8 overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-fuchsia-600 pb-16 pt-12 shadow-xl text-white">
        ...
        <div class="container mx-auto px-4 relative z-10 max-w-7xl">
            <div class="mb-8">
                ...
                <h1 class="text-3xl md:text-4xl font-extrabold tracking-tight drop-shadow-md"><?php echo e($project->title); ?></h1>
            ...
            <div class="rounded-2xl bg-white/10 p-5 backdrop-blur-md border border-white/20 shadow-inner">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="text-xl font-extrabold text-white"><?php echo e($projectSubmission->progress_percent); ?>%</span>
                </div>
                <div class="h-3 w-full rounded-full bg-black/20 overflow-hidden shadow-inner">
                    <div class="h-full rounded-full bg-gradient-to-r from-emerald-300 to-emerald-400 transition-all duration-1000 ease-out shadow-[0_0_10px_rgba(52,211,153,0.5)]" style="width: <?php echo e($projectSubmission->progress_percent); ?>%"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 max-w-7xl -mt-12 relative z-20">
        ...
        <div class="mb-8 rounded-3xl bg-white p-6 shadow-lg border border-slate-100">
            <div class="flex items-center justify-between relative">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stepProgress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="flex flex-1 items-center relative z-10">
                        <div class="flex flex-col items-center group cursor-default w-full">
                            <div class="flex h-14 w-14 items-center justify-center rounded-full border-4 transition-all duration-300 <?php echo e($item['is_current'] ? 'border-indigo-500 bg-indigo-50 shadow-md scale-110' : ($item['status'] === 'approved' ? 'border-emerald-500 bg-emerald-50 shadow-sm' : ($item['status'] === 'rejected' ? 'border-rose-500 bg-rose-50 shadow-sm' : 'border-slate-200 bg-white'))); ?>">
                                ...
                                <?php else: ?>
                                    <span class="text-lg font-extrabold <?php echo e($item['is_current'] ? 'text-indigo-600' : 'text-slate-400'); ?>"><?php echo e($item['step']->step_order); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <span class="mt-3 text-[11px] uppercase tracking-wider font-bold text-center <?php echo e($item['is_current'] ? 'text-indigo-600' : 'text-slate-500'); ?>"><?php echo e($item['step']->step_name); ?></span>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($index < count($stepProgress) - 1): ?>
                            <div class="absolute top-7 left-1/2 w-full -mt-[2px] h-1 <?php echo e($item['status'] === 'approved' ? 'bg-emerald-400' : 'bg-slate-200'); ?>" style="z-index: -1;"></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep): ?>
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 flex flex-col gap-6">
                ...
                <div class="rounded-3xl bg-white p-8 shadow-sm border border-slate-200 relative overflow-hidden group/step hover:shadow-md transition-shadow">
                    ...
                    <div class="mb-8">
                        <h2 class="text-2xl font-extrabold text-slate-900 mb-2"><?php echo e($currentStep->step_name); ?></h2>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep->instructions): ?>
                            <div class="mt-4 rounded-2xl bg-indigo-50/50 p-5 border border-indigo-100">
                                <p class="text-sm text-indigo-900 leading-relaxed"><?php echo e($currentStep->instructions); ?></p>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep->resource_file_path): ?>
                            <div class="mt-6 rounded-2xl border border-slate-200 bg-white p-5 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow group">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs font-medium text-slate-500 mt-1"><?php echo e($currentStep->resource_file_name); ?></p>
                                    </div>
                                </div>
                                <a href="<?php echo e($currentStep->resource_file_url); ?>" target="_blank" class="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-bold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50 hover:text-indigo-600 transition-colors">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStepSubmission && in_array($currentStepSubmission->status, ['submitted', 'under_review'])): ?>
                        <div class="rounded-2xl border border-amber-200 bg-amber-50 p-5 shadow-inner">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm font-medium text-amber-700">Bạn đã nộp bài lần <?php echo e($currentStepSubmission->submission_number); ?>. Vui lòng chờ phản hồi từ giáo viên.</p>
                                </div>
                            </div>
                        </div>
                    <?php elseif($currentStepSubmission && $currentStepSubmission->status === 'rejected'): ?>
                        <div class="rounded-2xl border border-rose-200 bg-rose-50 p-6 shadow-inner">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStepSubmission->feedback): ?>
                                        <div class="mt-4 rounded-xl bg-white p-4 border border-rose-100 shadow-sm">
                                            ...
                                            <p class="text-sm font-medium text-slate-700 leading-relaxed"><?php echo e($currentStepSubmission->feedback); ?></p>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        </div>
                    <?php elseif($currentStepSubmission && $currentStepSubmission->status === 'approved'): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$currentStepSubmission || in_array($currentStepSubmission->status, ['draft', 'rejected'])): ?>
                        <div class="mt-8 border-t border-slate-100 pt-8">
                            <h3 class="text-lg font-bold text-slate-900 mb-6">Nộp bài của bạn</h3>
                            <form wire:submit.prevent="submit" class="space-y-6">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep->requiresFile()): ?>
                                    <div class="rounded-2xl bg-slate-50 p-6 border border-slate-200 border-dashed hover:border-indigo-400 transition-colors">
                                        <label class="block text-sm font-bold text-slate-700 mb-2">
                                            Upload File <?php echo e($currentStep->submission_type === 'file' ? '*' : '(Tùy chọn)'); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep->allowed_file_types): ?>
                                            <p class="mt-3 text-xs font-medium text-slate-500">Loại file: <span class="text-slate-700"><?php echo e($currentStep->getAllowedFileTypesString()); ?></span> &bull; Tối đa: <span class="text-slate-700"><?php echo e($currentStep->max_file_size_mb); ?> MB</span></p>
                                        <?php else: ?>
                                            <p class="mt-3 text-xs font-medium text-slate-500">Tối đa: <span class="text-slate-700"><?php echo e($currentStep->max_file_size_mb); ?> MB</span></p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($file): ?>
                                            <div class="mt-4 rounded-xl bg-emerald-50 p-4 border border-emerald-100 text-sm font-bold text-emerald-700 flex items-center gap-2 shadow-sm">
                                                ...
                                                Đã chọn: <?php echo e($file->getClientOriginalName()); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep->requiresLink()): ?>
                                    <div>
                                        <label class="block text-sm font-bold text-slate-700 mb-2">
                                            Link <?php echo e($currentStep->submission_type === 'link' ? '*' : '(Tùy chọn)'); ?>

                                        </label>
                                        <input type="text" wire:model.defer="link_url" placeholder="<?php echo e($currentStep->link_placeholder ?? 'Nhập link (ví dụ: https://github.com/...)'); ?>" class="w-full rounded-xl border-slate-200 px-4 py-3 bg-white focus:border-indigo-500 focus:ring-indigo-500 transition-colors shadow-sm" />
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-sm font-medium text-rose-600"><?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                ...
                                <div class="flex justify-end gap-3 pt-4">
                                    ...
                                    <button type="submit" class="rounded-xl bg-indigo-600 px-8 py-3 text-sm font-bold text-white shadow-md hover:bg-indigo-700 hover:shadow-lg transition-all" <?php if($isSubmitting): ?> disabled <?php endif; ?>>
                                        Nộp bài
                                    </button>
                                </div>
                            </form>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($projectSubmission->score !== null): ?>
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row gap-8 items-center md:items-start">
                        <div class="flex flex-col items-center justify-center shrink-0">
                            <div class="w-28 h-28 rounded-full border-[6px] border-indigo-100 bg-white flex items-center justify-center shadow-lg relative">
                                ...
                                <span class="text-4xl font-black text-indigo-600"><?php echo e($projectSubmission->score); ?></span>
                            </div>
                        ...
                        <div class="flex-1 w-full pt-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($projectSubmission->feedback): ?>
                                <div class="bg-indigo-50/80 rounded-2xl p-5 border border-indigo-100">
                                    <p class="text-indigo-900 leading-relaxed font-medium italic">"<?php echo e($projectSubmission->feedback); ?>"</p>
                                </div>
                            <?php else: ?>
            ...
            <div class="space-y-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStepSubmission): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currentStepSubmission->getStatusLabel()),'color' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currentStepSubmission->getStatusColor()),'class' => 'shadow-sm']); ?>
...
<?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStepSubmission->hasFile()): ?>
                                <div class="rounded-xl bg-slate-50 p-4 border border-slate-100">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-sm font-medium text-slate-900 truncate" title="<?php echo e($currentStepSubmission->file_name); ?>"><?php echo e(Str::limit($currentStepSubmission->file_name, 25)); ?></span>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStepSubmission->hasLink()): ?>
                                <div class="rounded-xl bg-slate-50 p-4 border border-slate-100">
                                    <label class="text-[10px] font-bold uppercase tracking-wider text-slate-500 block mb-2">Link</label>
                                    <a href="<?php echo e($currentStepSubmission->link_url); ?>" target="_blank" class="inline-flex items-center gap-2 text-sm font-bold text-indigo-600 hover:text-indigo-800 transition-colors group">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/>
                                        </svg>
                                        <span class="group-hover:underline underline-offset-2"><?php echo e(Str::limit($currentStepSubmission->link_url, 25)); ?></span>
                                    </a>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStepSubmission->submitted_at): ?>
                                <div class="rounded-xl bg-slate-50 p-4 border border-slate-100 flex items-center justify-between">
                                    ...
                                    <p class="text-sm font-bold text-slate-900"><?php echo e($currentStepSubmission->submitted_at->format('d/m/Y H:i')); ?></p>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                    ...
                    <div class="space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stepProgress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$item['is_current']): ?>
                                <button wire:click="switchStep(<?php echo e($item['step']->id); ?>)" class="group w-full rounded-2xl border border-slate-100 bg-white p-4 text-left transition-all hover:border-indigo-200 hover:bg-indigo-50 hover:shadow-sm <?php echo e(in_array($item['status'], ['approved', 'rejected', 'submitted', 'under_review']) ? '' : 'opacity-50 cursor-not-allowed'); ?>">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-50 text-xs font-bold text-slate-400 group-hover:bg-white group-hover:text-indigo-600 transition-colors">
                                                <?php echo e($item['step']->step_order); ?>

                                            </div>
                                            <span class="text-sm font-bold text-slate-700 group-hover:text-indigo-900 transition-colors"><?php echo e($item['step']->step_name); ?></span>
                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['status'] === 'approved'): ?>
    ...
    <?php else: ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allSteps->isEmpty()): ?>
                        ...
                        <div class="relative z-10 flex flex-col md:flex-row gap-8 items-center md:items-start">
                            <div class="flex flex-col items-center justify-center shrink-0">
                                <div class="w-28 h-28 rounded-full border-[6px] border-emerald-50 bg-white flex items-center justify-center shadow-md relative">
                                    ...
                                    <span class="text-4xl font-black text-emerald-600"><?php echo e($projectSubmission->score); ?></span>
                                </div>
                                <span class="mt-4 text-[11px] font-bold uppercase tracking-widest text-slate-500">Điểm tổng kết</span>
                            </div>
                            <div class="flex-1 w-full pt-2">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($projectSubmission->feedback): ?>
                                    <div class="bg-emerald-50/80 rounded-2xl p-5 border border-emerald-100">
                                        <p class="text-emerald-900 leading-relaxed font-medium italic text-sm">"<?php echo e($projectSubmission->feedback); ?>"</p>
                                    </div>
                                <?php else: ?>
...
<?php /**PATH D:\IT-Learning\Modules/Learning\resources/views/livewire/student/submit-project.blade.php ENDPATH**/ ?>