    ...
    <div class="container px-6 py-3 mx-auto md:flex md:justify-between md:items-center">
      ...
      <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
        ...
        <div class="flex flex-col md:flex-row md:mx-6 gap-1 md:gap-0">
          ...
          <a class="<?php echo e(request()->is('/') ? 'text-blue-400 font-bold bg-blue-500/10' : 'text-slate-300 hover:text-white hover:bg-slate-700/30'); ?> 
          ...
          <a class="<?php echo e(request()->is('documents*') ? 'text-blue-400 font-bold bg-blue-500/10' : 'text-slate-300 hover:text-white hover:bg-slate-700/30'); ?> 
                              px-4 py-2.5 rounded-xl transition-all duration-300 transform md:mx-2 md:my-0 my-1"
          ...
          <a class="<?php echo e(request()->is('exam*') ? 'text-blue-400 font-bold bg-blue-500/10' : 'text-slate-300 hover:text-white hover:bg-slate-700/30'); ?> 
                              px-4 py-2.5 rounded-xl transition-all duration-300 transform md:mx-2 md:my-0 my-1"
            href="<?php echo e(route('exam.index')); ?>">
            Đề thi
          </a>

          
          <a class="<?php echo e(request()->is('learning*') ? 'text-blue-400 font-bold bg-blue-500/10' : 'text-slate-300 hover:text-white hover:bg-slate-700/30'); ?> 
                              px-4 py-2.5 rounded-xl transition-all duration-300 transform md:mx-2 md:my-0 my-1"
            href="<?php echo e(route('learning.roadmaps.index')); ?>">
            Lộ trình học tập
          </a>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 animate-pulse drop-shadow-[0_0_8px_rgba(251,191,36,0.8)]']); ?>
...
<?php endif; ?>
          ...
          <div x-data="{ dropdownOpen: false }" class="relative my-2 md:my-0">
            ...
            <button @click="dropdownOpen = !dropdownOpen" @click.away="dropdownOpen = false"
              ...
              <img
                src="<?php echo e(Auth::user()->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name) . '&background=3b82f6&color=fff&bold=true'); ?>"
                alt="User Avatar"
                class="w-9 h-9 rounded-full border-2 border-blue-400/50 shadow-md group-hover:border-blue-300 transition-all shrink-0">
              
              <span class="font-medium font-sans truncate max-w-[120px] sm:max-w-none"><?php echo e(Auth::user()->name); ?></span>
...
<?php $attributes = $attributes->except(\WireUi\Components\Icon\Index::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 shrink-0 group-hover:text-blue-300 transition-colors']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <div x-show="dropdownOpen" x-cloak x-transition:enter="transition ease-out duration-200"
              ...
              <a href="<?php echo e(route('auth.profile')); ?>"
...
<?php $attributes = $attributes->except(\WireUi\Components\Icon\Index::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-blue-400']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('student.purchases')): ?>
                <a href="<?php echo e(route('student.purchases')); ?>"
                  class="block px-4 py-3 text-sm text-slate-300 hover:bg-slate-700/70 hover:text-white transition-all group">
                  <div class="flex items-center gap-3">
                    <div
                      ...
                      <?php if (isset($component)) { $__componentOriginal8fb227d09011c9831b75a18671cea295 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8fb227d09011c9831b75a18671cea295 = $attributes; } ?>
<?php $component = WireUi\Components\Icon\Index::resolve(['name' => 'shopping-bag'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\WireUi\Components\Icon\Index::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-emerald-400']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('exam.results')): ?>
                <a href="<?php echo e(route('exam.results')); ?>"
                  class="block px-4 py-3 text-sm text-slate-300 hover:bg-slate-700/70 hover:text-white transition-all group">
                  <div class="flex items-center gap-3">
                    <div
                      ...
                      <?php if (isset($component)) { $__componentOriginal8fb227d09011c9831b75a18671cea295 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8fb227d09011c9831b75a18671cea295 = $attributes; } ?>
<?php $component = WireUi\Components\Icon\Index::resolve(['name' => 'chart-bar'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\WireUi\Components\Icon\Index::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-amber-400']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('student.transactions')): ?>
                <a href="<?php echo e(route('student.transactions')); ?>"
                  class="block px-4 py-3 text-sm text-slate-300 hover:bg-slate-700/70 hover:text-white transition-all group">
                  <div class="flex items-center gap-3">
                    <div
                      ...
                      <?php if (isset($component)) { $__componentOriginal8fb227d09011c9831b75a18671cea295 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8fb227d09011c9831b75a18671cea295 = $attributes; } ?>
<?php $component = WireUi\Components\Icon\Index::resolve(['name' => 'receipt-percent'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\WireUi\Components\Icon\Index::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-purple-400']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('student.bookmarks')): ?>
                <a href="<?php echo e(route('student.bookmarks')); ?>"
                  class="block px-4 py-3 text-sm text-slate-300 hover:bg-slate-700/70 hover:text-white transition-all group">
                  <div class="flex items-center gap-3">
                    <div
                      ...
                      <?php if (isset($component)) { $__componentOriginal8fb227d09011c9831b75a18671cea295 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8fb227d09011c9831b75a18671cea295 = $attributes; } ?>
<?php $component = WireUi\Components\Icon\Index::resolve(['name' => 'heart'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\WireUi\Components\Icon\Index::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-pink-400']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('contributor') || auth()->user()->hasRole('admin')): ?>
                <hr class="border-slate-700/70 my-2">
              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

              
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('contributor')): ?>
                <a href="<?php echo e(route('contributor.dashboard')); ?>"
                  ...
                  <div class="flex items-center gap-3">
                    <div
                      ...
                      <?php if (isset($component)) { $__componentOriginal8fb227d09011c9831b75a18671cea295 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8fb227d09011c9831b75a18671cea295 = $attributes; } ?>
<?php $component = WireUi\Components\Icon\Index::resolve(['name' => 'cloud-arrow-up'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\WireUi\Components\Icon\Index::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-blue-300']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Icon\Index::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-amber-300']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
</header><?php /**PATH D:\IT-Learning\resources\views/layouts/patials/user_header.blade.php ENDPATH**/ ?>