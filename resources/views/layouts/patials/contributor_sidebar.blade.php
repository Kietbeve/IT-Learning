<aside class="hidden w-72 shrink-0 border-r border-indigo-50 bg-white px-4 py-6 lg:block overflow-y-auto h-screen sticky top-0 text-slate-600 font-sans custom-scrollbar">
    ...
    @php
        $navItems = [
            ...
            ['label' => 'Quản lý câu hỏi', 'route' => '#', 'icon' => 'M9 12l2 2 4-4'],
            ['label' => 'Quản lý đề thi', 'route' => '#', 'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
            ...
            ['label' => 'Ví & Rút tiền', 'route' => '#', 'icon' => 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z'],
