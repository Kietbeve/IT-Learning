    ...
    <nav class="space-y-1">
        @php
            $navItems = [
                ...
                ['label' => 'Users', 'route' => 'admin.dashboard', 'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'],
                ...
                ['label' => 'Settings', 'route' => 'admin.dashboard', 'icon' => 'M12 8.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z'],
            ];
        @endphp
