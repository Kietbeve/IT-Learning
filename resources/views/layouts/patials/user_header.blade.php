...
<<<<<<< HEAD
    ...
    <nav class="hidden md:flex items-center gap-8 font-sans font-semibold text-sm">
        <a href="/" 
           class="{{ request()->is('/') ? 'text-primary-600 dark:text-primary-500 font-bold' : 'text-slate-600 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400' }} transition-colors duration-200">
            Trang chủ
        </a>
        <a href="{{ route('documents.index') }}" 
           class="{{ request()->is('documents*') ? 'text-primary-600 dark:text-primary-500 font-bold' : 'text-slate-600 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400' }} transition-colors duration-200">
            Kho tài liệu
        </a>
        <a href="/exam" 
           class="{{ request()->is('exam*') ? 'text-primary-600 dark:text-primary-500 font-bold' : 'text-slate-600 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400' }} transition-colors duration-200">
            Đề thi
        </a>
        <a href="/learning" 
           class="{{ request()->is('learning*') ? 'text-primary-600 dark:text-primary-500 font-bold' : 'text-slate-600 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400' }} transition-colors duration-200">
            Lộ trình học tập
        </a>
    </nav>
...
>>>>>>> 815687c034f6f79fd6ff6803f709379e450868d5
