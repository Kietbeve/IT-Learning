...
<header class="sticky top-0 z-50 w-full bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 shadow-xl border-b border-slate-700/50 backdrop-blur-sm">
        ...
        <div class="container px-6 py-3 mx-auto md:flex md:justify-between md:items-center">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('home.dashboard') }}"
                    ...
                    <span class="tracking-tight">IT<span class="text-blue-400 group-hover:text-blue-300 transition-colors">Learning</span></span>
                </a>
                ...
                @auth
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative my-2 md:my-0">
                        ...
                        <button @click="dropdownOpen = !dropdownOpen" @click.away="dropdownOpen = false"
                            ...
                            <img src="{{ Auth::user()->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name) . '&background=3b82f6&color=fff&bold=true' }}"
                                alt="User Avatar" 
                        ...
                        <div x-show="dropdownOpen" x-cloak 
                            ...
                            @if (auth()->user()->hasRole('admin'))
                                <a href="{{ route('admin.dashboard') }}"
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 rounded-lg bg-amber-500/30 flex items-center justify-center group-hover:bg-amber-500/40 transition-colors">
