                        ...
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-white font-bold text-sm md:text-base">
                                        🎁 <span class="hidden sm:inline">Ưu đãi đặc biệt!</span> Nâng cấp VIP - Tải tài
                                        liệu Premium giá hời - Chỉ từ 99,000đ/tháng
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-center gap-2 shrink-0">
                                ...
                                <button @click="dismiss"
                                    class="p-2 hover:bg-white/20 rounded-lg transition-colors duration-200" title="Đóng">
