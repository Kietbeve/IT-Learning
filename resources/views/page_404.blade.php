    ...
    <div class="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
        <div class="w-full ">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                {{-- Thẻ 1: Kho tài liệu --}}
                <a href="c{{ route('documents.index') }}" class="flex items-start gap-4 p-4 border border-slate-100 bg-slate-50/50 rounded-2xl hover:border-blue-500 hover:bg-white hover:shadow-md transition group">
