                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-4">
                    ...
                    <div class="flex flex-row gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <x-input name="keyword" icon="magnifying-glass"
                        ...
                        <button type="button" x-data="{ active: false }"
                            ...
                            :class="active ? 'border-1 border-blue-900 bg-gray-50' :
                                'border-gray-300 bg-white hover:border-1 hover:border-gray-400 hover:bg-gray-50'"
                        ...
                        {{-- Search Button --}}
                        <x-button indigo type="submit" icon="magnifying-glass" class="shrink-0 px-3! lg:px-4!">
                    ...
                    <div x-data="{ open: false }" x-on:toggle-filter.window="open = !open" x-show="open" x-transition
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div x-data="{ searchCategory: '' }">
                                ...
                                <input type="text" x-model="searchCategory" placeholder="Tìm danh mục..."
                                ...
                                <div
                                    class="space-y-2 max-h-28 overflow-y-auto border border-gray-200 rounded-xl p-3 scroll-smooth [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 hover:[&::-webkit-scrollbar-thumb]:bg-gray-400">

                                    <label class="flex items-center gap-2"
                                        x-show="!searchCategory || 'tất cả'.includes(searchCategory.toLowerCase())">
                                        <input type="radio" name="category" value="" class="border-gray-300"
                                    ...
                                    @foreach ($categories as $category)
                                        <label class="flex items-center gap-2"
                                            x-show="!searchCategory || '{{ mb_strtolower($category->name) }}'.includes(searchCategory.toLowerCase())">
                            ...
                            <div x-data="{ searchTag: '' }">
                                ...
                                <input type="text" x-model="searchTag" placeholder="Tìm tag..."
                                    class="mb-2 w-full text-xs py-1.5 px-3 border border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div
                                    ...
                                    @foreach ($tags as $id => $name)
                                        <label class="flex items-center gap-2"
                                            x-show="!searchTag || '{{ mb_strtolower($name) }}'.includes(searchTag.toLowerCase())">
                            ...
                            <div>
                                ...
                                <x-native-select label="Loại bài thi" name="type">
                            ...
                            <div>
                                ...
                                <x-native-select label="Sắp xếp" name="sort">
