<div class="max-w-4xl mx-auto space-y-6 font-sans pb-10">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-extrabold text-slate-850 tracking-tight">Đăng Tài Liệu (Admin)</h2>
            <p class="text-xs text-slate-400 mt-1">Đăng tải tài liệu trực tiếp - tự động phê duyệt.</p>
        </div>
        <a href="{{ route('admin.documents.index') }}" class="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-2xl border border-slate-200 bg-white text-xs font-bold text-slate-700 hover:bg-slate-50 transition-colors shadow-sm">
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative group border-2 border-dashed border-slate-200 rounded-3xl p-6 text-center hover:border-indigo-400 transition-colors bg-slate-50/50">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-[10px] text-slate-400 font-bold">PDF, DOC, DOCX, ZIP tối đa 50MB</p>
                        </div>
                    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-[2rem] border border-white bg-white/70 p-6 shadow-xl shadow-slate-100/50 backdrop-blur-md space-y-5">
                ...
                <div class="space-y-3" x-data="{ paid: @entangle('isPaid') }">
                    ...
                    <div x-show="paid" x-transition class="space-y-1.5 pt-1.5">
                        <label for="sale_price" class="text-[10px] font-bold text-slate-500 uppercase">Giá khuyến mãi (VND) <span class="text-slate-400 font-normal lowercase">(tùy chọn)</span></label>
                        <div class="relative">
            ...
            <div class="rounded-[2rem] border border-white bg-white/70 p-6 shadow-xl shadow-slate-100/50 backdrop-blur-md space-y-5">
                ...
                <div class="space-y-3">
                    <label class="text-xs font-extrabold text-slate-700">Ảnh bìa <span class="text-rose-500">*</span></label>
