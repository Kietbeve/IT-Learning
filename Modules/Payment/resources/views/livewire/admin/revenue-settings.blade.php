<div class="space-y-6">
    <div class="rounded-2xl border border-gray-200 bg-white">
        <div class="border-b border-gray-200 p-6">
            <h2 class="text-lg font-semibold text-gray-900">Cài đặt doanh thu & gói VIP</h2>
            <p class="text-sm text-gray-500">Quản lý phí nền tảng, hạn mức rút tiền và giá gói VIP</p>
        </div>
        ...
        <div class="p-6">
            <div class="space-y-6">
                <div class="grid gap-6 lg:grid-cols-2">
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Phí nền tảng (%)</label>
                        ...
                        <div class="mt-2 flex items-center gap-3">
                            <input type="number" wire:model="platformFeePercent" min="0" max="100"
                                   class="w-48 rounded-xl border-gray-300 text-sm">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Số tiền rút tối thiểu</label>
                        ...
                        <div class="mt-2 flex items-center gap-3">
                            <input type="number" wire:model="minPayoutAmount"
                                   class="w-48 rounded-xl border-gray-300 text-sm">
                            <span class="text-sm font-medium text-gray-600">đ</span>
                        </div>
                        @error('minPayoutAmount') <span class="text-xs text-rose-600">{{ $message }}</span> @enderror
                    </div>
                </div>

                <div class="grid gap-6 border-t border-gray-100 pt-6 sm:grid-cols-3">
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Giá gốc gói VIP</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Giá khuyến mãi VIP</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Số lượt tải (Quota)</label>
                        <p class="mt-1 text-xs text-gray-500">Số lượt tải tài liệu khi mua gói VIP</p>
                        <div class="mt-2 flex items-center gap-3">
                            <input type="number" wire:model="vipQuota"
                                   class="w-full rounded-xl border-gray-300 text-sm">
                            <span class="text-sm font-medium text-gray-600">lượt</span>
                        </div>
