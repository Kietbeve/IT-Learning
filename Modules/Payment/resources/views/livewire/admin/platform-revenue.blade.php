<div class="space-y-6">
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <div class="rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <p class="mt-4 text-3xl font-bold text-slate-900">{{ number_format($totalRevenue) }}đ</p>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <p class="mt-4 text-3xl font-bold text-slate-900">{{ number_format($revenueThisMonth) }}đ</p>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <p class="mt-4 text-3xl font-bold text-slate-900">{{ number_format($pendingPayouts) }}đ</p>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <p class="mt-1 text-sm text-slate-500">Đã trả cho contributor: {{ number_format($totalPaid) }}đ</p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                <template x-for="(value, index) in @js($chartData)" :key="index">
                    <div class="rounded-xl border border-slate-200 bg-slate-50 p-3 hover:border-blue-300 hover:bg-blue-50 transition-colors">
                        <div class="text-xs font-semibold text-slate-500 mb-1" x-text="@js($chartCategories)[index]"></div>
