    ...
    <x-modal wire:model="showModal" max-width="2xl" persistent>
        <div class="relative z-10 bg-white rounded-2xl shadow-2xl p-6 md:p-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-bold text-blue-900">Thanh toán tài liệu</h2>
                <button wire:click="close" class="rounded-full p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition">
            ...
            >
                    <div x-show="isExpired" class="text-center py-8">
                        ...
                        <h3 class="text-xl font-bold text-blue-900 mb-2">Mã QR đã hết hạn</h3>
                        <p class="text-gray-500 mb-6">Vui lòng đóng và thực hiện mua lại.</p>
                    ...
                    <div x-show="!isExpired" class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        ...
                        <div class="space-y-4 mt-2">
                            ...
                            <p class="text-sm text-gray-500 mb-4">Sử dụng Ứng dụng ngân hàng hoặc Ví điện tử để quét mã hoặc chuyển khoản thủ công.</p>
